                    ...
                    <?php } ?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="email" name="id" required="required" value="<?= time(); ?>" readonly class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="dosen" required="required" placeholder="Input Email"class="form-control col-md-7 col-xs-12">
                            <option value="">-- Pilih --</option>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" id="email" name="waktu" required="required" placeholder="Input Waktu"class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
