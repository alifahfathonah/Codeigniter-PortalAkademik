                      ...
                      <div class="profile_img">
                        <div id="crop-avatar">
                          ...
                          <?php foreach($foto as $row){ ?>
                            ...
                            <?php }else{ ?>
                              <img class="img-responsive avatar-view" src="<?= base_url().'assets/' ?>images/<?= $row['foto']; ?>" alt="Avatar" title="Change the avatar">
                            <?php } ?>
                        </div>
                      </div>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                          ...
                          <form action="<?= base_url().'siakad/gantipasswordmhs/' ?>" method="post">
                            <!-- start user projects -->
                          ...
                          <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                              <form action="<?= base_url().'siakad/updatephotomhs' ?>" method="post" enctype="multipart/form-data">
                                <div class="item form-group">
