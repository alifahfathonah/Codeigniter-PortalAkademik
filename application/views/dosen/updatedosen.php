          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Edit Dosen <small></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form method="post" action="<?= base_url().'siakad/prosesupdatedosen' ?>" class="form-horizontal form-label-left" novalidate>
                    ...
                    <?php } ?>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" value="<?= $row['NIDN'] ?>" data-validate-length-range="6" data-validate-words="2" name="nidn" placeholder="Input NIDN" required="required" type="text" readonly>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" value="<?= $row['nama_dosen']; ?>" data-validate-length-range="6" data-validate-words="2" name="nama" placeholder="Input Nama Dosen" required="required" type="text">
                        </div>
                      </div>
                      <div class="item form-group">
